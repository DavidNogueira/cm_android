...
import com.example.student.all_concepts.adapters.CustomArrayAdapter;
...
public class WS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://172.23.197.134:8888/ws_lista.php";
    ...
    public boolean onContextItemSelected(MenuItem item){
        ...
        switch(item.getItemId()){
            ...
            case R.id.post:
                ...
                String url = "http://172.23.197.134:8888/ws_idade.php";
