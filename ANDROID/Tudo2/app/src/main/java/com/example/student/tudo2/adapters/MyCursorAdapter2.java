package com.example.student.tudo2.adapters;
...
import com.example.student.tudo2.R;
import com.example.student.tudo2.db.Contrato;
...
public class MyCursorAdapter2 extends CursorAdapter {
    ...
    public void bindView(View mView, Context context, Cursor cursor){
        ...
        text3.setText(String.valueOf(mCursor.getString(cursor.getColumnIndexOrThrow(Contrato.Pessoa.COLUMN_ID_CIDADE))));
