...
public class ViewPagerExampleActivityDois extends Activity {
    ...
    static class TouchImageAdapter extends PagerAdapter {
        ...
        private static int[] images = { R.drawable.pad2, R.drawable.pad3, R.drawable.pad4, R.drawable.pad5, R.drawable.pad6, R.drawable.pad7, R.drawable.pad8, R.drawable.pad9, R.drawable.pad10, R.drawable.pad11, R.drawable.pad12, R.drawable.pad13, R.drawable.pad14};
